                ...
                <div class="card mb-4">
                    <div class="card-header pb-3">
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <a href="{{ route('buku.create') }}" class="btn bg-gradient-primary btn-sm mb-0"
                                type="button">+&nbsp; Buku Baru</a>
                        </div>
                    </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th
                                            ...
                                            Cover</th>
                                        <th
                                            class="text-center text-uppercase text-start text-secondary text-xxs font-weight-bolder opacity-7">
                                            Judul</th>
                                        <th
                                            class="text-center text-uppercase text-start text-secondary text-xxs font-weight-bolder opacity-7">
                                            Penulis</th>
                                ...
                                <tbody>
                                    @foreach ($data as $buku)
                                        <tr>
                                            ...
                                            <td class="text-start">
                                                <p class="text-xs font-weight-bold mb-0">{{ $buku->jumlah }}</p>
                                            </td>
                                            <td class="text-start">
