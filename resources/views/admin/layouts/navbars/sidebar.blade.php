<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0  border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse   w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  {{ Route::currentRouteName() == 'beranda' ? 'active' : '' }}" href="{{ route('beranda') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/buku') || request()->is('admin/buku/*') ? 'active' : '' }}" href="{{ route('buku.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-book fs-6 text-center {{ request()->is('admin/buku') || request()->is('admin/buku/*') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Buku</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/penulis') || request()->is('admin/penulis/*') ? 'active' : '' }}" href="{{ route('penulis.index') }}">

                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-user-friends fs-6 text-center {{ request()->is('admin/penulis') || request()->is('admin/penulis/*') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Penulis</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ Route::currentRouteName() == 'listpinjam' ? 'active' : '' }} " href="{{ route('listpinjam') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-list-alt fs-6 text-center {{ request()->is('admin/listpinjam') || request()->is('admin/listpinjam/*') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Daftar Pinjam Buku</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'history' ? 'active' : '' }}  " href="{{ route('history') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-book-open fs-6 text-center {{ request()->is('admin/history_borrow') || request()->is('admin/history_borrow') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Top Pinjam Buku</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'history_user' ? 'active' : '' }}  " href="{{ route('history_user') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Top User pinjam</span>
                </a>
            </li>
